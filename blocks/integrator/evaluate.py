"""
evaluate.py — Simulation and validation utilities for Gm-C Integrator.

Provides:
- NGSpice simulation runner
- DC gain, unity-gain freq, output swing, leakage, reset time, charge injection measurements
- PVT corner sweep
...
def validate(quick: bool = False):
    ...
    meas = {
        "dc_gain_db": 0,
        "unity_gain_freq_mhz": 0,
        "output_swing_mv": 0,
        "leakage_mv_per_us": 100,
        "reset_time_ns": 100,
        "charge_inject_mv": 100,
        "power_uw": 0,
    }
